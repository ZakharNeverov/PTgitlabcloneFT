...
namespace teslenko
{
  ...
  public:
    ...
    void uniteDictionaries(std::vector< std::map< std::string, std::vector< int > > >& arrayDictionaries, std::ostream& os);
    void subtractionDictionaries(std::vector< std::map< std::string, std::vector< int > > >& arrayDictionaries, std::ostream& os);
    void getIntersectionDictionaries(std::vector< std::map< std::string, std::vector< int > > >& arrayDictionaries, std::ostream& os);
