...
namespace yermakov
{
  ...
  void doWrite(std::ostream&, yermakov::TextDict&, std::string&);
  void doCalculateSize(std::ostream&, yermakov::TextDict&, std::string&);
  void doPrint(std::ostream&, yermakov::TextDict&, std::string&);
  void doCompress(std::ostream&, yermakov::TextDict&, std::string&);
  void doDecompress(std::ostream&, yermakov::TextDict&, std::string&);
  void doEfficiency(std::ostream&, yermakov::TextDict&, std::string&);
