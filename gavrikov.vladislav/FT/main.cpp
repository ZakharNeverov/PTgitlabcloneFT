...
int main()
{
  ...
  std::map< std::string, std::function< void(void) > > commands
  {
    ...
    {"printDict", std::bind(gavr::printDict, std::ref(dicts), std::ref(std::cin), std::ref(std::cout))},
    ...
    {"countPref", std::bind(gavr::countPref, std::ref(dicts), std::ref(std::cin), std::ref(std::cout))},
