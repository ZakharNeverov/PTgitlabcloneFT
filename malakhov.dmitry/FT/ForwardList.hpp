...
namespace malakhov
{
  ...
  public:
    ...
    public:
      ...
      ForwardListNode(const ForwardListNode& instance):
        stored(instance.stored),
        tail(instance.tail ? new ForwardListNode{*(instance.tail)} : nullptr)
      {}
    ...
    ForwardList(const ForwardList& instance):
      tail_(instance.tail_ ? new ForwardListNode{*(instance.tail_)} : nullptr)
    {}

    ForwardList(ForwardList&& instance) noexcept:
      tail_(instance.tail_)
    {
      instance.tail_ = nullptr;
    }
